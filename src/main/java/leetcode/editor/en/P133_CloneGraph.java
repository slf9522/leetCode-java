...
// 
//
// Related Topics Hash Table Depth-First Search Breadth-First Search Graph 👍 92
//37 👎 3712
...
public class P133_CloneGraph {
    public static void main(String[] args) {
        ...
        nei.add(new Node(2));
        System.out.println(solution.cloneGraph(new Node(1, nei)));
    }
